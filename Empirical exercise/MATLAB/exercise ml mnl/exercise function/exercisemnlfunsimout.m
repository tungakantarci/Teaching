...
Beta_true = [0.5,0.5;0.1,0.1;1,1]; % K x J-1. The rows are for K coefficients. The columns are for J-1 choice alternatives. Which column is for which alternative?
...
% Beta_true = reshape(Beta_true,K,J-1); % K x J-1.
