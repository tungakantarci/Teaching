...
% -------------------------------------------------------------------------
cd '/Users/Tunga/Library/Mobile Documents/com~apple~CloudDocs/Academic/Teaching/Workshop/MW/MW Script file'
edit scriptfile
...
% -------------------------------------------------------------------------
clear;
filename = '/Users/Tunga/Library/Mobile Documents/com~apple~CloudDocs/Academic/Teaching/Workshop/MW/MW Data/MW csv file.csv';
delimiterIn = ',';
headerlinesIn = 1;
mwmatfile = importdata(filename,delimiterIn,headerlinesIn);
save('/Users/Tunga/Library/Mobile Documents/com~apple~CloudDocs/Academic/Teaching/Workshop/MW/MW Data/MW mat file.mat','mwmatfile');

% -------------------------------------------------------------------------
% 8. Opening Data Files
% -------------------------------------------------------------------------
clear;
load '/Users/Tunga/Library/Mobile Documents/com~apple~CloudDocs/Academic/Teaching/Workshop/MW/MW Data/MW mat file.mat';
...
mwmatfile.data(mwmatfile.data(1:20,4) == 1,[1 2 4]);
...
mean(mwmatfile.data(mwmatfile.data(:,4) == 1,1),1); % You can suppress ,1 at the end.
...
options = optimoptions('fminunc','SpecifyObjectiveGradient',true,...
    'MaxFunctionEvaluations',100,'MaxIterations',100,'Display','iter');
[B_hat_OLS_Section_20,SSR,exitflag,output,ObjectiveGradient,hessian] = ...
    fminunc(@(B_hat)MWFunctionSSR(y,X,B_hat),B_hat_ig,options);
